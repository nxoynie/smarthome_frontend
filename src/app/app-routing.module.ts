...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () => import('./pages/connected-devices/connected-devices.module').then( m => m.ConnectedDevicesPageModule)
  },
  {
    path: 'manual-input',
    loadChildren: () => import('./pages/manual-input/manual-input.module').then( m => m.ManualInputPageModule)
  },
  {
